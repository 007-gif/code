...
from macls.models.mobile import MobileNetV3_Small
from macls.models.my_model import MyModel
...
class MAClsTrainer(object):
    ...
    def __setup_model(self, input_size, is_train=False):
        ...
        elif self.configs.use_model == 'Mobile':
            self.model = MobileNetV3_Small(input_size=input_size, **self.configs.model_conf)
        elif self.configs.use_model == 'my_model':
            self.model = MyModel(input_size=input_size, **self.configs.model_conf)
        else:
    ...
    def train(self,
        ...
        # 获取模型
        # print(self.audio_featurizer.feature_dim)  80
